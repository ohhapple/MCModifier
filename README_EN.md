# Homepage URL https://ohhapple.github.io
...
## 📋 Requirements
- Java Version: ≥ 11 (JDK 11 or higher)
- Operating System: This program is developed for Windows systems; compatibility with other systems (macOS/Linux) has not been tested.
- Minecraft Version: ≥ 26.1(compatible Carpet Mod version required)
...
- Do not send log information to others. If Minecraft is logged in with a genuine account, the process name will contain the player's UUID and authentication key information. Be careful to protect your privacy, and you are responsible for the consequences.
